...
> После привязки не входите в приложение Kaspi Pay под номером кассира — это разрывает подключение. Если мастер не проходит, [поддержка в WhatsApp](https://wa.me/77085167489) подключит вручную.
