...
| `description` | string | Нет | Описание (макс. 60 символов — Kaspi показывает покупателю только первые 60) |
...
> ⚠️ **Описание подписки живёт по тому же правилу, что и описание счёта.** С 5 сентября 2026 изменённое
> описание длиннее 60 символов вернёт `422`; организации, зарегистрированные с 26 августа 2026, живут на
> этом лимите уже сейчас. Проверяется только **изменённое** описание: правка других полей у подписки со
